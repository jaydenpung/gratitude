...
environments {
    development {
        ...
        grails.serverURL = "http://localhost:8080/gratitude"
    }
    production {
        grails.logging.jul.usebridge = false
        grails.serverURL = "https://gratitudehampers.jaypung.com"   // Beware this is an application-wide setting 
    }
}
...
grails.plugin.springsecurity.interceptUrlMap = [
    ...
    '/dashboard/checkout':  ['IS_AUTHENTICATED_FULLY'],
